...
if (!empty($nopgdn)) {
    ...
    $stmt_faktur_list = $koneksi->prepare("SELECT pemesanan.no_faktur, SUM(detailpesan.subtotal) AS tagihan
        FROM pemesananspjgabungan
        JOIN pemesanan ON pemesananspjgabungan.no_faktur = pemesanan.no_faktur
    ...
    while ($row = $result_faktur_list->fetch_assoc()) {
        $faktur_list[] = $row;
    }
        ...
        <div class="page-break">
            ...
            <table border="1" cellpadding="5" cellspacing="0" style="margin-top: 8px;">
                ...
                <tr>
                    ...
                    <td>445 /&nbsp;&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;&nbsp;/PHPL/LL.04/<?php echo $bulan_romawi; ?>/<?php echo $tahun; ?></td>
                </tr>
                <tr>
