...
<div class="container">
    ...
    <div class="left">
        <h2>Data Pasien Poliklinik Penyakit Dalam</h2>
        <?php
        ...
        if (mysqli_num_rows($result_int) > 0) {
            ...
            echo "<p>Tidak ada data ditemukan untuk poliklinik penyakit dalam.</p>";
        }
        ?>
    </div>
    ...
    <div class="right">
        <h2>Data Pasien Poliklinik THT</h2>
        <?php
        ...
        if (mysqli_num_rows($result_tht) > 0) {
            ...
            echo "<p>Tidak ada data ditemukan untuk poliklinik THT.</p>";
        }
