    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <table class="no-border-table">
                ...
                <tr><td>Nomor</td><td>:</td><td>445 / <?php echo isset($pemesanan['no_order']) ? $pemesanan['no_order'] : '..........'; ?>.01/ PPBJ / LL.04 /<?php echo !empty($bulan_romawi) ? $bulan_romawi : '.....'; ?>/ <?php echo !empty($tahun) ? $tahun : '.....'; ?></td></tr>
    ...
    <div class="container">
        ...
        <div class="page-break">
            ...
            <table class="no-border-table">
                ...
                <tr><td> </td><td>3. Surat permintaan Pengadaan Barang/Jasa Nomor : 445/<?php echo isset($pemesanan['no_order']) ? $pemesanan['no_order'] : ''; ?>.01/LL.04/<?php echo !empty($tahun) ? $tahun : '.....'; ?> tanggal 
    ...
    <div class="container">
        ...
        <div class="page-break">
            ...
            <table class="no-border-table">
                ...
                <tr><td> </td><td>3. Surat permintaan e-purchasing Nomor : 445/<?php echo isset($pemesanan['no_order']) ? $pemesanan['no_order'] : ''; ?>.01/LL.04/<?php echo !empty($tahun) ? $tahun : '.....'; ?> tanggal 
                        <?php echo !empty($tanggal_awal_bulan) ? $tanggal_awal_bulan : '.........'; ?></td></tr>
                <tr><td> </td></tr>
    ...
    <div class="container">
        ...
        <div class="page-break">
            ...
            <table class="no-border-table">        
                ...
                <?php echo !empty($bulan_romawi) ? $bulan_romawi : '..........'; ?>/<?php echo !empty($tahun) ? $tahun : '.....'; ?> Tanggal <?php echo !empty($tanggal_awal_bulan) ? $tanggal_awal_bulan : '.........'; ?>, dengan rincian sebagai berikut :</td></tr>
            </table>   
        ...
        <div class="page-break">
            ...
            <table>
                ...
                <th>PBF/PAK</th>
                    ...
                    <td><div class="supplier-info"style="text-align: center;"><?php echo isset($pemesanan['no_order']) ? $pemesanan['no_order'] : ''; ?>/SP/<?php echo isset($pemesanan['kode_suplier']) ? $pemesanan['kode_suplier'] : ''; ?>/LL.04/  /<?php echo !empty($tahun) ? $tahun : '.....'; ?></td>
    ...
    <div class="container">
        ...
        <div class="page-break">
            ...
            <table class="no-border-table">        
                ...
                <tr><td>No. Surat Pesanan</td><td>:</td><td><?php echo isset($pemesanan['no_order']) ? $pemesanan['no_order'] : ''; ?>/SP/<?php echo isset($pemesanan['kode_suplier']) ? $pemesanan['kode_suplier'] : ''; ?>/LL.04/<?php echo !empty($bulan_romawi) ? $bulan_romawi : '..'; ?>/<?php echo !empty($tahun) ? $tahun : '.....'; ?></td></tr>
        ...
        <div class="page-break">
            ...
            <table border="1" cellpadding="5" cellspacing="0" style="margin-top: 8px;">
                ...
                <tr>
                    ...
                    <td>445 /<?php echo isset($pemesanan['no_order']) ? $pemesanan['no_order'] : ''; ?>/&nbsp;&nbsp;&nbsp;&nbsp;/PHPL/LL.04/<?php echo $bulan_romawi; ?>/<?php echo $tahun; ?></td>
                </tr>
                <tr>
