    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <table class="no-border-table">
                ...
                <tr><td>Tanggal</td><td>:</td><td>1 November 2025</td></tr>
    ...
    <div class="container">
        ...
        <div class="page-break">
            ...
            <table class="no-border-table">
                ...
                <tr><td> </td><td>3. Surat permintaan Pengadaan Barang/Jasa Nomor : 445/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;.01/ PPBJ / LL.04 /...../ 2025 tanggal 1 November 2025 </td></tr>
            </table>
            <table class="no-border-table">
...
<body>
    <div class="container">
        ...
        <table class="no-border-table">
            ...
            <!-- Tanda Tangan -->
            <div class="signature" style="text-align: center;">
                <p><?php echo isset($datasuplier['kota']) ? $datasuplier['kota'] : ''; ?>, ..... November 2025</p>
...
<body>
    <div class="container">
        ...
        <div class="page-break">
            ...
            <div class="signature" style="text-align: center;">
                <p>Pringsewu, 29 November 2025</p>
                <p>Pejabat Pelaksana Teknis Kegiatan</p>
                <p>Belanja bahan Habis Pakai (BAHP) Rumah Sakit</p>
                <br>
                <br>
