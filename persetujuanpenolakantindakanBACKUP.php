...
<body>
    <div class="container">
        ...
        <div class="print-button">
            ...
            if (!empty($no_pernyataan)) {
                $pdf_filename = "pdf/persetujuan_" . preg_replace('/[^a-zA-Z0-9]/', '_', $no_pernyataan) . ".pdf";
            ...
            <button type="button" id="btnSavePDF" class="btn-pdf" <?php echo empty($no_pernyataan) ? 'disabled' : ''; ?>>
                💾 Simpan ke PDF
            </button>
        ...
        <div class="content">
            ...
            $no_pernyataan = $tanggal_pernyataan = $penerima_informasi = $alasan_penolakan = "";
            ...
            <div class="form-section">
                <table>
                    ...
                    <tr>
                        <th colspan="6">
                            Dengan ini menyatakan <u><?php echo !empty($alasan_penolakan) ? 'PENOLAKAN TINDAKAN MEDIK' : 'PERSETUJUAN TINDAKAN MEDIK'; ?></u> :
                            <br>
                                (..............................................................................................................................)
                            </th>
                        </th>
    ...
    <script>
        ...
        document.getElementById('btnSavePDF').addEventListener('click', function () {
            ...
            if (pdfExists) {
                if (!confirm('⚠️ File PDF sudah ada!\n\nApakah Anda ingin mengganti file PDF yang sudah ada?')) {
                    return;
                }
            }
            ...
            xhr.send('no_pernyataan=' + encodeURIComponent(noPernyataan) + '&no_rawat=' + encodeURIComponent(<?php echo json_encode($no_rawat); ?>));
        });
