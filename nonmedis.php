...
<head>
    ...
    <title>Menu Jasa Pelayanan</title>
    <!-- Font Awesome CDN -->
...
<body>
    ...
    <div class="container">
        ...
        <div class="icon-menu">
            <a href="pengeluarannonmedis.php" title="Pengeluaran Barang Non Medis">
                <img src="images/nonmedis.png" alt="Pengeluaran Barang Non Medis Icon" style="width: 60px; height: 60px; margin-bottom: 12px; object-fit: contain;">
                <span>Pengeluaran Barang Non Medis</span>
            </a>
        </div>
    </div>
