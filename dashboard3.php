...
<div class="container">
    ...
    <div class="left">
        <h2>Data Pasien Poliklinik Kandungan dan Kebidanan</h2>
        <?php
        ...
        if (mysqli_num_rows($result_int) > 0) {
            ...
            echo "<p>Tidak ada data ditemukan untuk poliklinik Kandungan dan Kebidanan.</p>";
        }
        ?>
    </div>
    ...
    <div class="right">
        <h2>Data Pasien Poliklinik Anak</h2>
        <?php
        ...
        if (mysqli_num_rows($result_tht) > 0) {
            ...
            echo "<p>Tidak ada data ditemukan untuk poliklinik Anak.</p>";
        }
