...
<div class="container">
    ...
    <div class="menu-grid">
        ...
        <a href="penjualan_bebas.php" class="menu-item" title="Penjualan Bebas">
            <i class="fas fa-prescription-bottle-alt fa-2x" style="color:#d97706;"></i>
            <span style="color:#222;font-weight:bold;">Penjualan Bebas</span>
        </a>       
