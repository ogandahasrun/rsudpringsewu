...
<body>
    <div class="container">
        ...
        <div class="page-break">
            ...
            <h2 class="center-text">BERITA ACARA PEMERIKSAAN BARANG</h2>
            <h4 class="center-nomorsurat">Nomor : 445/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/LL.04/2025</h4>
            <br></br>
            <p> Pada hari ini &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                tanggal &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                bulan &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                tahun Dua Ribu Dua Puluh Empat (&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/2025),
            </p>
            <table class="no-border-table">        
            ...
            <table class="no-border-table" style="text-align: center;">
                <tr><td>1</td><td><?php echo isset($datasuplier['nama_suplier']) ? $datasuplier['nama_suplier'] : ''; ?></td><td><?php echo isset($datasuplier['direktur']) ? $datasuplier['direktur'] : ''; ?></td><td>..................</td></tr>
