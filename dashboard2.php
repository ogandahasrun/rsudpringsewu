...
<div class="container">
    ...
    <div class="left">
        <h2>Data Pasien Poliklinik Syaraf</h2>
        <?php
        // Sertakan file koneksi
        include 'koneksi.php';

        // Query untuk poliklinik 'klt'
        $query_int = "
            SELECT
                reg_periksa.no_reg,
                pasien.nm_pasien,
        ...
        if (mysqli_num_rows($result_int) > 0) {
            ...
            echo "<p>Tidak ada data ditemukan untuk poliklinik syaraf</p>";
        }
        ?>
    </div>
    ...
    <div class="right">
        <h2>Data Pasien Poliklinik Kulit dan Kelamin</h2>
        <?php
        ...
        if (mysqli_num_rows($result_tht) > 0) {
            ...
            echo "<p>Tidak ada data ditemukan untuk poliklinik Kulit dan Kelamin</p>";
        }
